...
directory_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../.././sql_queries/2_ma_detail'))
    ...
    def test_generator(file):
        def test(self):
            sql_file_path = os.path.abspath(
                os.path.join(os.path.dirname(__file__), f'../.././sql_queries/2_ma_detail/{file}'))
