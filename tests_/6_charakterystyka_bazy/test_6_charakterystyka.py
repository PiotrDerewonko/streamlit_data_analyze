...
from pages.charakterystyka_bazy.download_data_new import *
...
def test_generate_data_about_age():
    generate_data_about_donor(con, engine, True)
    data = download_data_about_donor(con, engine, True)
