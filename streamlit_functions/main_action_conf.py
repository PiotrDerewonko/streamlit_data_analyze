            ...
            with st.container():
                ...
                with st.container():
                    ...
                    with c3:
                        ...
                        nc_axis = st.selectbox(options=['Oś pomocnicza', 'Oś główna'], label='Rodzaj wykresu dla nakładu')
                    ...
                    with c6:
                        ...
                        szlw_axis = st.selectbox(options=['Oś pomocnicza', 'Oś główna'], label='Rodzaj wykresu dla SZLW')
